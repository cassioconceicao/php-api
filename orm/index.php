...
if (isset($_GET["create"])) {
    ...
    try {
        ...
        echo "<pre>";
        echo "Modelo(s), Controle(s) e 'View(s)' gerado(s) com sucesso!<br /><br />MENU:<br />";
        echo implode(",\n", $menu);
    } catch (Exception $ex) {
        echo $ex->getMessage();
    }
...
function getSelectedsId() {
    if (isset($_POST["selecteds_id"])) {
        return $_POST["selecteds_id"];
    } else if (isset($_GET["selecteds_id"])) {
        return $_GET["selecteds_id"];
    } else {
        return false;
    }
}
...
function getHTMLHead($charset = "UTF-8") {
...
function getMenu() {
    ...
    $menuList = "<a href=\"" . VIEW_PATH . "\">&#9758; Home</a>\n";
